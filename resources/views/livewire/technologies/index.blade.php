<div>
    @forelse ($technologies as $technology)
        <div wire:key='tech-{{ $technology->id }}' class="bg-white shadow-sm rounded mt-2 p-4 flex flex-col items-center justify-center sm:flex-row gap-5 sm:justify-between">
            
            <div class="flex items-center justify-center gap-3">

                <img 
                    loading="lazy" 
                    src="{{ asset('storage/icons/' . $technology->icon) }}" 
                ...
                <p class="text-gray-500 text-sm w-full [overflow-wrap:anywhere]">
            ...
            <div class="flex justify-between gap-2">
                ...
                <button type="button" wire:click="$dispatch('delete', {{$technology->id}})" class="w-8 h-8 bg-red-100 text-red-500 hover:text-red-600 p-1 transition-colors duration-300 ease-linear focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
